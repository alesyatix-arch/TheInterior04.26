    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-12 xl:px-16 relative z-10">
        <div className="max-w-3xl mx-auto mb-12 text-center">
          <span className="inline-block text-sm font-body font-medium uppercase tracking-[0.2em] text-primary mb-5">
            Квиз
          </span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-semibold text-foreground">
            Подберите подходящий формат за 2 минуты
          </h2>
        </div>
